...
{
    int maxH=0;
    int curH1=0, curH2=0 , curH3=0 , curMaxH=0;
    while(1)
    {
        if(curH1 == curH2 && curH1 == curH3)
        {
        ...
        {
            if(curH1 < curMaxH && h1_count)
                curH1 += h1[--h1_count];
            else if(curH1 < curMaxH)
                break;

            if(curH2 < curMaxH && h2_count)
                curH2 += h2[--h2_count];
            else if(curH2 < curMaxH)
                break;

            if(curH3 < curMaxH && h3_count)
                curH3 += h3[--h3_count];
            else if(curH3 < curMaxH)
                break;
        }
        if(curH1 > curMaxH)    curMaxH = curH1;
        if(curH2 > curMaxH)    curMaxH = curH2;
        if(curH3 > curMaxH)    curMaxH = curH3;
